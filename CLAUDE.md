...
| `src/kernel/store.ts`                | Durable run store (`~/.claw-orchestrator/wf/<runId>/`) + the single atomic-write / append-JSONL helpers                                                                                                                                      |
...
| `src/kernel/templates/`              | Built-in workflows (`solve`, `council`, `fanout`)                                                                                                                                                                                            |
